function play(){
    ...
    setTimeout(function() {
        document.getElementById("frame6-2").style.visibility = "visible";
    }, 7600);
    
    setTimeout(function() {
        document.getElementById("frame6-3").style.visibility = "visible";
    }, 7700);
    
    setTimeout(function() {
        document.getElementById("frame6-4").style.visibility = "visible";
    }, 7800);
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame14").style.display = "flex";
    }, 12000);
    
    setTimeout(function() {
        document.getElementById("frame14-text2").style.visibility = "visible";
    }, 12700);
    
    setTimeout(function() {
        document.getElementById("frame14-text3").style.visibility = "visible";
    }, 13800);
    
    setTimeout(function() {
        document.getElementById("frame14").remove();
        document.getElementById("frame15").style.display = "block";
    }, 14300);
    
    setTimeout(function() {
        document.getElementById("frame15-B").style.visibility = "visible";
    }, 14500);
    
    setTimeout(function() {
        document.getElementById("frame15-C").style.visibility = "visible";
    }, 14750);
    
    setTimeout(function() {
        document.getElementById("frame15-D").style.visibility = "visible";
    }, 15000);
    
    setTimeout(function() {
        document.getElementById("frame15").remove();
        document.getElementById("frame16").style.display = "block";
    ...
    setTimeout(function() {
        document.getElementById("frame16-text1B").style.visibility = "visible";
    }, 16450);
    
    setTimeout(function() {
        document.getElementById("frame16-text2").style.visibility = "visible";
    }, 16850);
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame19").style.display = "flex";
    }, 19700); 
    
    setTimeout(function() {
        document.getElementById("frame19").remove();
        document.getElementById("frame20").style.display = "flex";
    }, 20100); 
    
    setTimeout(function() {
    
        document.getElementById("frame20").style.backgroundColor = "black";
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame20A").style.display = "flex";
    }, 20700); 
    
    setTimeout(function() {
        document.getElementById("frame20A").remove();
        document.getElementById("frame21").style.display = "flex";
    }, 21100); 
    
    setTimeout(function() {
        document.getElementById("frame21").remove();
        document.getElementById("frame22").style.display = "flex";
    }, 21350); 
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame24-text").innerHTML = "WHEN"
    }, 23800);
    
    setTimeout(function() {
        document.getElementById("frame24-text").innerHTML = "I"
        document.getElementById("frame24-text").style.fontSize = "75px";
    }, 24200);
    
    setTimeout(function() {
        document.getElementById("frame24-text").innerHTML = "LOOKED"
        document.getElementById("frame24-text").style.fontSize = "90px";
    }, 24500);
    
    setTimeout(function() {
        document.getElementById("frame24-text").innerHTML = "IN"
        document.getElementById("frame24-text").style.fontSize = "115px";
    }, 24800);
    
    setTimeout(function() {
        document.getElementById("frame24-text").innerHTML = "YOUR"
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame26-text0").style.display = "block";
    }, 27000);//26800
    
    setTimeout(function() {
        document.getElementById("frame26-text1").style.display = "block";
    }, 27500);//27000
    
    setTimeout(function() {
        document.getElementById("frame261B").style.visibility = "visible";
    }, 27800);//27200
    ...
    setTimeout(function() {
        ...
        document.getElementById("frame28").style.display = "block";
    }, 29300);
    
    setTimeout(function() {
        document.getElementById("frame28").remove();
        document.getElementById("frame29").style.display = "block";
    }, 29700);
